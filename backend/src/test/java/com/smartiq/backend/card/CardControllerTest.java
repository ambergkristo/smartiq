...
class CardControllerTest {
    ...
    @Test
    void returnsBadRequestWhenNextRandomLanguageTooLong() throws Exception {
        mockMvc.perform(get("/api/cards/nextRandom")
                        .param("language", "a".repeat(33))
                        .param("gameId", "game-oversized-language"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.error").value("language is too long"));
    }

    @Test
    void returnsBadRequestWhenNextRandomLanguageContainsControlChars() throws Exception {
        mockMvc.perform(get("/api/cards/nextRandom")
                        .param("language", "en\nx")
                        .param("gameId", "game-control-language"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.error").value("language contains control characters"));
    }
    ...
    @Test
    void returnsBadRequestWhenNextRandomGameIdTooLong() throws Exception {
        mockMvc.perform(get("/api/cards/nextRandom")
                        .param("language", "en")
                        .param("gameId", "g".repeat(129)))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.error").value("gameId is too long"));
    }
    ...
    @Test
    void returnsBadRequestWhenLegacyNextSessionIdTooLong() throws Exception {
        mockMvc.perform(get("/api/cards/next")
                        .param("topicId", "Math")
                        .param("difficulty", "2")
                        .param("sessionId", "s".repeat(129))
                        .param("lang", "en"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.error").value("sessionId is too long"));
    }

    @Test
    void returnsBadRequestWhenLegacyNextSessionIdContainsControlChars() throws Exception {
        mockMvc.perform(get("/api/cards/next")
                        .param("topicId", "Math")
                        .param("difficulty", "2")
                        ...
                        .param("lang", "en"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.error").value("sessionId contains control characters"));
    }
