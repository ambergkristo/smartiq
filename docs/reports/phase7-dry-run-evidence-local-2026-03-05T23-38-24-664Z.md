...
- Generated at (UTC): 2026-03-05T23:38:25.053Z
- Candidate commit SHA: ecbebd7
- Backend URL: offline-fixture
- Workflow run ID: n/a
- Workflow run URL: n/a
- Beta summary report path: C:/Users/Kasutaja/smartiq/docs/reports/beta-summary-local-2026-03-05T23-38-24-664Z.md
...
| Beta go/no-go gate | FAIL | exitCode=2, recommendation=NO-GO |
| Synthetic dry-run aggregate | FAIL | smoke + gate combined |

## Beta Summary Extract

- Report exists: yes
- Report recommendation: NO-GO
- Report failed checks: 2
