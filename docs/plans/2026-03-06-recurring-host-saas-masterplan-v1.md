...
11. `M7` technical work may now proceed in parallel with the deferred `M6` external-proof blocker, starting with the public recurring-host launch surface and conversion entry.
