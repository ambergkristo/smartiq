...
| M3 | S3 | Auth + tenant isolation hardening | auth/isolation suite green | DONE (DEMO, 2026-03-05) |
...
4. `S3/M3` demo gate pass is complete.
5. `S4/M4` remains locked for production path until demo evidence is replaced with real business/legal evidence.
